            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <ul>
                        ...
                        <li>Please note, we've reserved both an Economy and an Oceanfront room block for Saturday night. Mention Degenaars-Bendet when calling to secure the discounted rate.</li>
                    </ul><br></br>
                    ...
                    <ul>
                        ...
                        <li>Please note, we've reserved a room block for both Friday and Saturday night. Mention DWS when calling to secure the discounted rate.</li>
                    </ul><br></br>
